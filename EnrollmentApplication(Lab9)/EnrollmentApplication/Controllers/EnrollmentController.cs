...
namespace EnrollmentApplication.Controllers
{
    public class EnrollmentController : Controller
    {
        ...
        public ActionResult MonthStudent()
        {
            ...
            var Student = GetMonthStudent();
            return PartialView("_MonthStudent", Student);
        }
        ...
        public ActionResult Create([Bind(Include = "EnrollmentId,StudentId,CourseId,Grade,Notes")] Enrollment enrollment)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "EnrollmentId,StudentId,CourseId,Grade,Notes")] Enrollment enrollment)
        {
            if (ModelState.IsValid)
            {
